...
impl Default for BunnyMark {
    fn default() -> Self {
        ...
        painter.rect_f((1, 0), (2, 16), paint(FourBits::White));
        painter.rect_f((5, 0), (2, 16), paint(FourBits::White));
        painter.rect_f((0, 5), (8, 5), paint(FourBits::White));
        painter.rect_f((2, 10), (4, 4), paint(FourBits::White));
        painter.mod_pixel((2, 7), paint(FourBits::Pink));
        painter.mod_pixel((5, 7), paint(FourBits::Pink));
        painter.line((7, 5), (7, 9), paint(FourBits::Gray));
